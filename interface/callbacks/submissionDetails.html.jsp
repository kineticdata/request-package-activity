...
<%} else {
%>
<div class="submissionDetails" title="<%= ThemeLocalizer.getString(packageResourceBundle, "Submission Details")%>">
    <div class="header">
        <div class="requestId">
        ...
        <div class="serviceItem"><%= ThemeLocalizer.getString(serviceItemsResourceBundle, submission.getTemplateName())%></div>
        <div class="close"></div>
        <div class="clearfix"></div>
    </div>
    <div class="info">
        <div class="label"><%= ThemeLocalizer.getString(packageResourceBundle, "Status")%></div>
        <div class="value"><%= ThemeLocalizer.getString(packageResourceBundle,submission.getValiationStatus())%></div>
        <div class="clearfix"></div>
